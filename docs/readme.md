...
|-------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
|[Latest Version](https://github.com/JarlPenguin/TorBrowserPortable/releases/download/8.0.4.995/TorBrowserPortable_8.0.5_Dev_Test_5.paf.exe)|[Legacy Versions](https://github.com/JarlPenguin/TorBrowserPortable/releases)|
