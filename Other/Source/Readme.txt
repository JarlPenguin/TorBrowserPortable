...
user in an INI file next to TorBrowserPortable.exe called TorBrowserPortable.ini.
...
copy AppNamePortable.ini from this directory to TorBrowserPortable.ini next to
TorBrowserPortable.exe. The options in the INI file are as follows:
